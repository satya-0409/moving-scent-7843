import { Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Box, Button, Container, Flex, Heading, Input, Link, Text } from "@chakra-ui/react";
    ...
    return (
        <div>
            ...
            <Flex mt="10px" fontSize="lg" p="10px" justifyContent="space-around">
                ...
                <Link>
                <Box fontWeight={"bold"}>STORE LOCATOR</Box>
                </Link>
            </Flex>

            <Box mt="20px" mb="50px">
                This Website is made by Satya Prakassh in 2023
            </Box>
